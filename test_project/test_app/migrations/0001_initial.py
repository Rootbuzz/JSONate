    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('normal_field1', models.CharField(default='field1', max_length=25)),
                ('normal_field2', models.CharField(default='field2', max_length=25)),
                ('sensitive_field1', models.CharField(default='sensitive', max_length=25)),
